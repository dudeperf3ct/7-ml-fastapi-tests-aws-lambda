...
class SentimentBertModel:
    ...
    def __init__(self, model_name: str = 'distilbert-base-uncased-finetuned-sst-2-english') -> None:
        ...
        logger.info(f"Using {self.model_name} finetuned model for sentiment classification")
    ...
    def predict(self, text: str) -> dict:
        ...
        logger.info(f"Input Attention mask: {attention_mask} Shape: {attention_mask.shape}")
        with torch.no_grad():
